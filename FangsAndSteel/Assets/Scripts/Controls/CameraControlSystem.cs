...
{
    private LocalInputData inputData;
    ...
    protected override void OnCreate()
    {
        ...
        RequireForUpdate<LocalInputData>();
    }
    ...
    {
        foreach (LocalInputData inputData in SystemAPI.Query<LocalInputData>().WithAll<GhostOwnerIsLocal>())
        {
            //inputData = SystemAPI.GetSingleton<LocalInputData>();
