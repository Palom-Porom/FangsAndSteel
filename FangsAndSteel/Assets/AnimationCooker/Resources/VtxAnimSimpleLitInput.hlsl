...
CBUFFER_START(UnityPerMaterial)
    ...
    float _SpeedInst; // vtxanim
    float _SpeedMat; // vtxanim
    float _ClipIdx; // vtxanim
    float _CurTime; // vtxanim
    float4 _BaseMap_ST;
    half4 _BaseColor;
    half4 _SpecColor;
...
CBUFFER_END
    ...
    UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
        ...
        UNITY_DOTS_INSTANCED_PROP(float, _CurTime) // vtxanim
        UNITY_DOTS_INSTANCED_PROP(float, _ClipIdx) // vtxanim
        UNITY_DOTS_INSTANCED_PROP(float, _SpeedInst) // vtxanim
    ...
    #define _SpeedInst          UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _SpeedInst) // vtxanim
    #define _CurTime            UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _CurTime) // vtxanim
    #define _ClipIdx            UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _ClipIdx) // vtxanim
#endif
